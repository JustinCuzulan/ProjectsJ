...
public class Graph {
    ...
    public List<String> getPath(String startNode, String endNode){
        ...
        queue.add(startNode);
        // Sve dok ide queue znaci da ima neobidjenih cvorova unutra queua.
        ...
        while (queue.size() != 0) {
            ...
            while (i.hasNext()) {
                ...
                //pitamo se da li smo ikada prije vidjeli susjeda
                if (weights.containsKey(n.getEndNode())) {
                    ...
                    // tezina puta od roditelja do susjeda i Tezina puta od pocetnog cvora do roditelja
                    weights.put(n.getEndNode(), n.getWeight() + weights.get(curr));
                    //ubacujemo u mapu parenta (neighbour, parent)
                    parentsMap.put(n.getEndNode(), curr);
                    queue.add(n.getEndNode());
